...
opensesame_pilot <- "data_tables/pilot"
...
```{r, include=FALSE}
opensesame_german <- "data_tables/german_exp"
...
if(file.exists("data_tables/RDS/loo_german.RDS")){
    loo_german <- readRDS("data_tables/RDS/loo_german.RDS")
    kfold_german <- readRDS("data_tables/RDS/kfold_german.RDS")
} else {
     loo_german <- map(m_german$models, loo, pointwise = TRUE)
     saveRDS(loo_german, file = "data_tables/RDS/loo_german.RDS")
