...
```{r}
est_SSP_exp <- results_txt(m_hebrew$models$SSP, "moSSP")
est_MSD_exp <- results_txt(m_hebrew$models$MSD, "moMSD")
est_SSP_col <- results_txt(m_hebrew$models$SSP_obs, "moSSP_obs")
est_MSD_col <- results_txt(m_hebrew$models$MSD_obs, "moMSD_obs")
est_NAP_td <- results_txt(m_hebrew$models$NAP_td, "moNAP_td")
est_NAP_bu <- results_txt(m_hebrew$models$NAP_bu, "sNAP_bu")
```
