...
<!-- See Chapter \@ref(sec:lingMod) and especially Section \@ref(sec:risenfall) for more on the problems related to the assumption of discrete segments in continuous signals of speech. -->
...
<!-- The design of Experiment 3 was similar to Experiment 2, only here the subjects were native Hebrew speakers, listening to stinlus set HN, featuring recordings of a native German speaker. -->
...
<!-- ## Experiment 1: Exploratory pilot study (Experiment 1) {#sec:experiment1} -->
...
<!-- ### Experiment 1: Estimation {#sec:results1} -->
...
<!-- Note that the exploratory study, Experiment 1,  -->
<!-- which was administered while the various parameters of the models were still undergoing development and change, was not designed to distinguish between the models, as it had a relatively small number of observations -->
<!-- was not designed to distinguish between the models, as it had a relatively small number of observations  -->
<!-- and it was administered while the various parameters of the models were still undergoing development and change.  -->
...
<!-- ### Experiment 2: Estimation {#sec:results2} -->
...
### SSP models {#sec:traditionalModelfit}
...
<!-- ### Experiment 3: Descriptive adequacy -->
...
comparison%>%
    ...
    left_join(weights %>% tibble::enframe() %>%
     ...
     apa_table(escape = FALSE, caption ="(\\#tab:modelstacking) All models comparison (Experiment 3)",note= "(plot details are same as above).")
...
<!-- [^cf-pilot]: The exploratory study included also nine clusters with glides, which we later discarded from our confirmatory studies. The actual number of data points per subject in Experiment 1 was therefore higher, with 76 data points per subject (adding nine targets and nine fillers that we excluded from this analysis). -->
