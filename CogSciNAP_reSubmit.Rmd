...
(ii) in Subsection \@ref(sec:projection) we discuss the universality of sonority, with special attention to the body of works by Iris Berent and her colleagues.
...
The NAP approach appears capable of synthesizing the different views on the origins of universal sonority. Like many of the works by Berent and her colleagues, the bottom-up model of NAP can explain the universality of sonority as the natural development of communication systems that exploit the auditory effects of pitch. The top-down model of NAP is, at the same time, very much in line with phonotactic learners, where it is possible to learn the regularities of language from the symbolic abstractions that reflect the speakers' knowledge in stable forms. 
...
Given the above, we believe that the new findings and approaches presented in this paper will be able to deliver many more valuable insights into old and new problems in phonology and linguistic theory.
