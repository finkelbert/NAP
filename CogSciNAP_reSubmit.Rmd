...
Thirty-three native Hebrew speakers (`r length(which(subjects_heb$subject_gender=="female"))` female, `r length(which(subjects_heb$subject_gender=="male"))` male, and `r length(which(subjects_heb$subject_gender=="other"))` "other") participated in Experiment 3, of which `r length(which(subjects_heb$subject_hebrew_native=="monolingual"))` were monolingual (the five native bilinguals were also native speakers of English, Russian and Spanish.)
...
`r length(which(subjects_heb$subject_education =="school"))` of the 33 participants had no to very little academic background, `r length(which(subjects_heb$subject_education =="undergraduate"))` finished an *undergraduate* (*bachelor*) academic degree and `r length(which(subjects_heb$subject_education =="graduate"))` finished advanced *graduate* academic degrees (*master* and abve).
<!-- Of the 33 participants, 34 were students at the University of Cologne who took part in the experiment at the sound attenuated booth of the phonetics laboratory. The other 17 participants took part in the experiment at three different locations---all small quiet rooms within private apartments. All subjects were paid five Euros for their participation.  -->

The data collection in Experiment 3 was more diverse, and, perhaps more "noisy" as a result.
Th first phase, which took place during 2019, collected data from student volunteers in Tel Aviv University and The Hebrew University of Jerusalem. The second collection phase occurred already during the early phases of the global COVID-19 pandemic, which resulted in many ad-hoc locations and more heterogenous population in some respects. Notably, Hebrew speakers in this study tended to have a less robust understanding of the notion of the syllable such that their performance may exhibit higher degerees of misunderstanding of the the meta-linguistic task to count syllables.
...
As a novel measurement of the acoustic signal, *NAP~bu~*'s partial success is, in fact, quite impressive: it still has a big room for improvement and it is already as good as the best traditional models. *NAP~bu~* can directly enjoy from improvements in extraction of periodic energy in digital signal processing, from improvements in the conception of competition, and in the formulas used to estimate or simulate it.
