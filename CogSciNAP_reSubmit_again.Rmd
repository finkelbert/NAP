---
title             : "Modeling sonority in terms of pitch intelligibility with top-down and bottom-up versions of the Nucleus Attraction Principle"
...
We suggest a measurable acoustic correlate for sonority in terms of *periodic energy*, and we propose a novel principle, the *Nucleus Attraction Principle* (NAP), that accounts for syllabic well-formedness based on general principles of competition in real-time (considering the extent to which the different portions of the speech signal are good candidates for the syllabic nucleus). 
